...
namespace SwinAdventure
{
    public class Program
    {
        static void Main(string[] args)
        {
			...
			Path myroom2livingroom = new Path(new string[] { "east" }, "Door", "Travel through door", myroom, livingroom);
			Path livingroom2myroom = new Path(new string[] { "west" }, "Door", "Travel through door", livingroom, myroom);
            ...
            Item TV = new Item(new string[] { "TV" }, "a TV", "This is a television");
